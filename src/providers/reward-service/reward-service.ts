...
import { RewardModPage } from '../../pages/reward-mod/reward-mod';
...
export class RewardServiceProvider {
  ...
  constructor(private storage: Storage, public modelCtrl: ModalController) {
  ...
  displayReward(amount){
    let theModal = this.modelCtrl.create(RewardModPage, { 'rewardParam': amount});
    theModal.present();
  }
